...
import static core.backend.task3.ThreadUtil.sleep;
import static core.backend.task3.ThreadUtil.waitForAllThreadsToComplete;
...
public class Main {
    ...
    public static void demoMultipleProducersAndMultipleConsumers() {
        ...
        // let threads run for five seconds
        sleep(5000);
